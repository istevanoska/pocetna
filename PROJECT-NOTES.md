...
- **SEO, remaining after prerendering** (audit 2026-09-12, in impact order): per-route
  ...
  serve 200, no canonical); Open Graph + Twitter Card with a 1200×630 image; fill the 153
  empty `description` fields and render them as visible text; JSON-LD (`WebSite` +
